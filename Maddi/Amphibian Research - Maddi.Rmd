...
```{Basic plots}
#bar plot of order occurrence (IUCN)
library(ggplot2)
barplot(table(IUCN$orderName), names.arg=c("Anura","Caudata", "Gymnophiona"),main="Frequencies of Amphibian Orders",xlab="Order", ylab="Frequencies", col = c("#b9e38d", "#a1e9f0", "#d9b1f0"))

#bar plot of order occurrence vs. threatened status
